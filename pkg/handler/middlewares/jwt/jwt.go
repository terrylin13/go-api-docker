...
var (
	...
	TokenNotValidYet error  = errors.New("Token未通过校验")
	TokenMalformed   error  = errors.New("这不是合法的Token")
	TokenInvalid     error  = errors.New("检验失败")
	SignKey          string = "terry testing" // 签名信息应该设置成动态从库中获取
)
